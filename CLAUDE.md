...
| [`AotterClam/clam-cms-starter-publication`](https://github.com/AotterClam/clam-cms-starter-publication) | End-user `publication` starter template repo. Clone this for provisioning. The monorepo `starters/publication/` copy is a development mirror / fixture while the split completes. |

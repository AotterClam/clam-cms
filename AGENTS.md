...
Consumer projects scaffolded via `create-clam-cms` get a different, mantle-aware `AGENTS.md` templated
from [`_common/AGENTS.md.template`](https://github.com/AotterClam/clam-cms-starters/blob/main/_common/AGENTS.md.template)

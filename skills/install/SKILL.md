...
```bash
git clone --depth 1 --branch <template_ref> https://github.com/AotterClam/clam-cms-starter-publication.git .
```
...
| Symptom | Cause | Fix |
|---|---|---|
| `git clone` cannot access the starter repo | Network or Git installation issue | Confirm Git is installed and the repo is public. For publication, use `https://github.com/AotterClam/clam-cms-starter-publication`. |

...
[![CI](https://github.com/AotterClam/clam-cms/actions/workflows/ci.yml/badge.svg?branch=develop)](https://github.com/AotterClam/clam-cms/actions/workflows/ci.yml)
...
>
> clam-cms is co-developed with AI coding agents (Claude Code) and is
...
```bash
npx https://github.com/AotterClam/clam-cms-starters/releases/latest/download/aotterclam-create-clam-cms.tgz my-site
cd my-site
```
...
| `@aotterclam/clam-cms-cloudflare` | Cloudflare Workers adapter. Implements ports against D1 / KV / ASSETS. Ships `createAuth()` — the Better Auth-backed *default* implementation of the SDK's `Auth` contract (see [ADR-0014](docs/adr/0014-auth-better-auth-and-multi-tenant-mcp.md) § "Auth as contract, Better Auth as default"); replace by passing your own `Auth` instance. |
